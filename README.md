...
**Live → https://baditaflorin.github.io/mesh-spotlight/**

**Source → https://github.com/baditaflorin/mesh-spotlight**
...
git clone https://github.com/baditaflorin/mesh-spotlight
cd mesh-spotlight
npm install
npm run dev
```
...
- `mesh-spotlight:signalingUrl`
- `mesh-spotlight:turnTokenUrl`
- `mesh-spotlight:iceServers`
- `mesh-spotlight:room`
